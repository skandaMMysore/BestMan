...
var drops = [];
//creating maximum number of drops
var maxDrops = 100;
...
function setup(){
   ...
   for(var i = 0;i<maxDrops;i++){
       drops.push(new Drops(i,350,500));
   }
...
function draw(){
    ...
    //display rain drops
    //we are popping out 1 value from a list of drops and so, we have written display() and in that, mentioned new var a
